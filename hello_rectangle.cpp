...
int hello_rectangle() {
	...
	float vertices[] = {
		...
		0.5f, 0.5f, 0.0f, //Ponta direita cima
		0.5f, -0.5f, 0.0f, //Ponta esquerda cima
		-0.5f, -0.5f, 0.0f, //Ponta de esquerda baixo
		-0.5f, 0.5f, 0.0f //Ponta de direita baixo
	};

	//Especifica a ordem que o OpenGL vai renderizar os pontos, fazemos isso pra montar o retangulo
	...
	//Criando o element buffer object
	unsigned int EBO;
	glGenBuffers(1, &EBO);
	...
	//Copia o dado dos vertices pro EBO
